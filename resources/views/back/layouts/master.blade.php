...
<body class="bg-gray-100">
    ...
    <div class="flex">
        ...
        <div class="bg-gray-800 text-white w-48 p-4">
            ...
            <ul class="space-y-2">
                <li><a href="{{ route('dashboard') }}" class="flex items-center hover:bg-gray-700 p-2"><i class="fas fa-home text-sm mr-2"></i>Dashboard</a></li>
                <li><a href="{{ route('allBlogs') }}" class="flex items-center hover:bg-gray-700 p-2"><i class="fas fa-file-alt text-sm mr-2"></i>Blog</a></li>
                <li><a href="{{ route('categories') }}" class="flex items-center hover:bg-gray-700 p-2"><i class="fas fa-tags text-sm mr-2"></i>Categories</a></li>
                ...
                <div class="flex items-center space-x-4">
                    ...
                    <div class="relative inline-block text-left">
                        ...
                        <div class="origin-top-right absolute right-0 mt-2 w-48 rounded-md shadow-lg bg-white ring-1 ring-black ring-opacity-5 focus:outline-none hidden" role="menu" aria-orientation="vertical" aria-labelledby="user-menu-button" tabindex="-1">
                            ...
                            <a href="{{ route('profile') }}" class="block px-4 py-2 text-sm text-gray-700 hover:bg-gray-100" role="menuitem" tabindex="-1" id="user-menu-item1">Profile</a>
                            <a href="#" class="block px-4 py-2 text-sm text-gray-700 hover:bg-gray-100" role="menuitem" tabindex="-1" id="user-menu-item3">Logout</a>
                        </div>
