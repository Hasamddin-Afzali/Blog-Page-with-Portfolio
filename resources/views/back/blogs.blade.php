...
@section('content')
    ...
    <head>
        ...
        <!-- Add the following line to include CKEditor -->
            ...
            <div class="bg-white p-4 rounded-md shadow-md">
                ...
                <form action="#" method="POST">
                    ...
                    <div class="mb-4">
                        ...
                        <input type="file" id="images" name="images[]" class="w-full px-4 py-2 bg-gray-100 border border-gray-300 rounded-md focus:outline-none focus:ring-2 focus:ring-indigo-500 focus:border-indigo-500" multiple>
                    </div>
                    <div class="mb-4">
