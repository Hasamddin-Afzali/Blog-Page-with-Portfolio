...
<header class="bg-cover bg-center h-screen flex items-center text-white bg-no-repeat relative"
    ...
    <div class="container mx-auto text-center relative z-10">
        <h1 class="text-5xl font-bold mb-4"><span class="text-red-500">Contact</span></h1>
    </div>
</header>
        ...
        <section class=" pt-20 flex flex-col md:flex-row ">
            ...
            <div class=" md:w-full p-8">
                ...
                <form action="#" method="post" class="space-y-4">
                    ...
                    <button type="submit"
                        class="bg-blue-500 text-white px-4 py-2 rounded-md hover:bg-blue-700 focus:outline-none focus:shadow-outline">
                        Submit
                    </button>
                </form>
            </div>
                ...
                <div class="flex justify-center lg:justify-end space-x-4">
                    ...
                    <a href="#" class="text-blue-500 hover:text-blue-700">
                        <svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" stroke="currentColor"
                            ...
                            <!-- Your social media icon goes here -->
                            <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2"
                                d="M12 6v6m0 6v2m0-8l-3 3m6 0l3-3"></path>
                        </svg>
                    </a>
